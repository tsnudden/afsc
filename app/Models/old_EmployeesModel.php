...
class EmployeesModel extends Model {
	...
	function getEmployees() {
		...
		$employees = $this->db->select("Select * From ".PREFIX."_employees Where employee_status = 1");
	...
	function sendQualificationExpiryNotification($qualification_id, $employee_id) {
		...
		$headers .= 'To: ' . ADMIN_EMAIL . ' <' . ADMIN_EMAIL . '>' . "\r\n";
		$headers .= 'From: System Notifications <admin@afsc.awserver.co.uk>' . "\r\n";
		$headers .= 'Reply-To: System Notifications <admin@afsc.awserver.co.uk>' . "\r\n";
